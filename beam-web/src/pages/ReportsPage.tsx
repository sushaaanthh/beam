...
const reports = [
  {
    id: 'REP-2026-08',
    title: 'BEAM AI Longitudinal Emotional Intelligence & Behavioral Report',
    analysis: 'Personal Affective Timeline & SHAP Saliency Audit',
    generated: '2026-08-22 19:50',
    model: 'RoBERTa-v1.2 + Whisper + SHAP',
    status: 'READY',
    format: 'PDF (ReportLab 5.0)',
  },
  {
    id: 'REP-2026-07',
    title: 'Monthly Behavioral Affective Benchmark & Reflection Audit',
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-[#1C1C1C] pb-4">
        <div>
          <span className="text-[10px] font-mono text-[#C7FF4A] tracking-wider uppercase">
            BEAM AI // SYNTHESIS & REPORTLAB ENGINE
          </span>
          ...
          <p className="text-xs sm:text-sm text-[#73736F] mt-1">
            Download academic synthesis summaries, SHAP attribution diagrams, and longitudinal wellness PDFs.
          </p>
        </div>
